...
(function () {
  ...
  var option = {
    ...
    xAxis: [{
      type: 'category',
      data: ["计算机类", "电子信息类", "自动化类", "仪器类", "管理科学与工程类", "电器类", "能源动力类"],
      axisTick: {
        alignWithLabel: true
      },
      // 修改刻度标签，相关样式
    ...
    series: [{
      ...
      barWidth: '35%',
      // ajax传动态数据
      data: [6858, 6145, 5899, 5856, 5625, 5489, 5424],
      itemStyle: {
        // 修改柱子圆角
        barBorderRadius: 5
      }
...
(function () {
  ...
  var yearData = [{
      ...
      data: [
        // 两个数组是因为有两条线
        [5970, 6525, 6851, 6919, 7332],
        [4659, 5117, 5429, 5609, 6048]
      ]
    }
  ];
